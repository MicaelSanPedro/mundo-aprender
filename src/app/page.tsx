...
const categories = [
  ...
  {
    id: "ciencias", emoji: "🔬", name: "Ciências", color: "bg-emerald-500", shadow: "shadow-emerald-500", hoverBorder: "hover:border-emerald-400",
    subcategories: [
      { id: "cie-natureza", name: "Natureza e Meio Ambiente", emoji: "🌿" },
      { id: "cie-corpo", name: "Corpo Humano e Saúde", emoji: "🫀" },
      { id: "cie-experimentos", name: "Experimentos", emoji: "🧪" },
    ],
  },
  {
    id: "geografia", emoji: "🌍", name: "Geografia", color: "bg-amber-500", shadow: "shadow-amber-500", hoverBorder: "hover:border-amber-400",
    subcategories: [
      { id: "geo-mapas", name: "Mapas e Localização", emoji: "🗺️" },
      { id: "geo-cultura", name: "Culturas e Regiões", emoji: "🏠" },
      { id: "geo-meio", name: "Meio Ambiente", emoji: "♻️" },
    ],
  },
  {
    id: "artes", emoji: "🎨", name: "Artes", color: "bg-fuchsia-500", shadow: "shadow-fuchsia-500", hoverBorder: "hover:border-fuchsia-400",
    subcategories: [
      { id: "art-desenho", name: "Desenho e Pintura", emoji: "🖌️" },
      { id: "art-musica", name: "Música e Ritmo", emoji: "🎵" },
      { id: "art-teatro", name: "Teatro e Expressão", emoji: "🎭" },
    ],
  },
  {
    id: "educacao-fisica", emoji: "⚽", name: "Educação Física", color: "bg-red-500", shadow: "shadow-red-500", hoverBorder: "hover:border-red-400",
    subcategories: [
      { id: "ef-esportes", name: "Esportes e Jogos", emoji: "🏀" },
      { id: "ef-saude", name: "Saúde e Alongamento", emoji: "🧘" },
      { id: "ef-movimento", name: "Corpo e Movimento", emoji: "🏃" },
    ],
  },
];
...
const products: { id: number; name: string; description: string; price: number; originalPrice: number | null; rating: number; reviews: number; emoji: string; bgColor: string; borderHover: string; category: string; subcategory: string; tag: string | null; tagColor: string; ageRange: string; schoolYear: string; image?: string; link?: string; variants?: ProductVariant[] }[] = [
  ...
  {
    id: 3,
    name: "Laboratório de Descobertas",
    description: "Explore o mundo ao seu redor com atividades práticas de ciências! Animais, plantas, corpo humano, água, luz e muito mais. Aprenda brincando e se tornando um verdadeiro cientista!",
    price: 9.90,
    originalPrice: 14.90,
    rating: 5,
    reviews: 15,
    ...
    category: "ciencias",
    subcategory: "cie-natureza",
    tag: "Best-seller!",
    tagColor: "bg-emerald-500/90 text-white",
    ageRange: "6 a 10 anos",
    schoolYear: "1º ao 5º ano",
    image: "/product-ciencias-1.png",
  },
  {
    id: 4,
    name: "Meu Corpo é Incrível",
    description: "Descubra como funciona o corpo humano de um jeito divertido! Partes do corpo, sentidos, ossos, músculos, alimentação saudável e cuidados com a saúde. Atividades ilustradas e cheias de curiosidades!",
    price: 7.90,
    originalPrice: 12.90,
    rating: 5,
    reviews: 10,
    ...
    category: "ciencias",
    subcategory: "cie-corpo",
    tag: "Novo!",
    tagColor: "bg-kid-green/90 text-white",
    ageRange: "6 a 9 anos",
    schoolYear: "1º ao 4º ano",
    image: "/product-ciencias-2.png",
  },
  // ─── GEOGRAFIA ───
  {
    id: 5,
    name: "Aventura pelo Brasil",
    description: "Embarque numa viagem pelas regiões do Brasil! Conheça estados, capitais, rios, montanhas, culturas e tradições de cada lugar. Mapas ilustrados, quiz interativos e atividades de localização.",
    price: 8.90,
    originalPrice: 13.90,
    rating: 5,
    reviews: 11,
    ...
    category: "geografia",
    subcategory: "geo-cultura",
    tag: "Popular!",
    tagColor: "bg-amber-500/90 text-white",
    ageRange: "7 a 11 anos",
    schoolYear: "2º ao 5º ano",
    image: "/product-geo-1.png",
  },
  {
    id: 6,
    name: "Planeta Terra: Nosso Lar",
    description: "Descubra os segredos do nosso planeta! Continentes, oceanos, climas, vegetação, pontos cardeais, rosa dos ventos e muito mais. Atividades que transformam o estudo da geografia numa grande aventura!",
    price: 8.90,
    originalPrice: null,
    rating: 5,
    reviews: 7,
    emoji: "🌍",
    bgColor: "bg-gradient-to-br from-sky-500/10 to-cyan-500/10",
    borderHover: "hover:border-sky-400/40",
    category: "geografia",
    subcategory: "geo-mapas",
    tag: null,
    tagColor: "",
    ageRange: "7 a 10 anos",
    schoolYear: "2º ao 5º ano",
    image: "/product-geo-2.png",
  },
  // ─── ARTES ───
  {
    id: 7,
    name: "Caderno de Criatividade",
    description: "Solte a imaginação com atividades de desenho, pintura, colagem, dobradura e muito mais! Pontilhismo, arte com formas geométricas, mistura de cores, autorretrato e atividades inspiradas em grandes artistas.",
    price: 7.90,
    originalPrice: 11.90,
    rating: 5,
    reviews: 13,
    ...
    category: "artes",
    subcategory: "art-desenho",
    tag: "Favorito!",
    tagColor: "bg-fuchsia-500/90 text-white",
    ageRange: "5 a 10 anos",
    schoolYear: "1º ao 5º ano",
    image: "/product-artes-1.png",
  },
  {
    id: 8,
    name: "Mundo da Música",
    description: "Explore o universo musical! Instrumentos, ritmos, compasso, notas musicais, cantigas de roda, compositores famosos e atividades para criar sua própria música. Aprenda brincando com sons e melodias!",
    price: 6.90,
    originalPrice: null,
    rating: 5,
    reviews: 6,
    ...
    category: "artes",
    subcategory: "art-musica",
    tag: "Novo!",
    tagColor: "bg-kid-green/90 text-white",
    ageRange: "6 a 10 anos",
    schoolYear: "1º ao 5º ano",
    image: "/product-artes-2.png",
  },
  // ─── EDUCAÇÃO FÍSICA ───
  {
    id: 9,
    name: "Movimente-se e Aprenda",
    description: "Atividades de educação física para fazer em casa ou na escola! Alongamento, aquecimento, jogos cooperativos, circuito motor, brincadeiras antigas e desafios corporais. Saúde e diversão garantidas!",
    price: 6.90,
    originalPrice: 10.90,
    rating: 5,
    reviews: 9,
    ...
    subcategory: "ef-movimento",
    tag: "Promoção!",
    tagColor: "bg-red-500/90 text-white",
    ageRange: "5 a 11 anos",
    schoolYear: "1º ao 5º ano",
    image: "/product-ef-1.png",
  },
  {
    id: 10,
    name: "Jogos e Brincadeiras",
    description: "Um compilado de jogos e brincadeiras para educação física! Pique-pega, queimada, amarelinha, cabo de guerra, gincanas e muito mais. Com regras ilustradas, variações e adaptações para diferentes idades!",
    price: 7.90,
    originalPrice: null,
    rating: 5,
    reviews: 8,
    ...
    category: "educacao-fisica",
    subcategory: "ef-esportes",
    tag: null,
    tagColor: "",
    ageRange: "5 a 12 anos",
    schoolYear: "1º ao 6º ano",
    image: "/product-ef-2.png",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <div className="mt-6 sm:mt-8 flex flex-wrap gap-2 sm:gap-4 justify-center lg:justify-start">
                ...
                <div className="flex items-center gap-1 sm:gap-1.5 glass rounded-full px-2.5 sm:px-3 py-1 sm:py-1.5 text-white text-xs sm:text-sm">
                  <FileText className="h-3.5 w-3.5 sm:h-4 sm:w-4" /> Material Digital em PDF
                </div>
              </div>
            </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  { icon: Download, color: "kid-blue", title: "Download via MediaFire", desc: "Receba sua key e baixe seus PDFs" },
              ...
              >
                ...
                <div className="mt-4 bg-[#25D366]/10 rounded-2xl p-4 border-2 border-[#25D366]/20">
                  ...
                  <p className="text-xs text-foreground/60 mb-3">
                    Após pagar, envie o comprovante pelo WhatsApp para receber sua key de ativação. O download dos PDFs é feito pelo <a href="https://pt.wikipedia.org/wiki/MediaFire" target="_blank" rel="noopener noreferrer" className="text-kid-orange underline underline-offset-2 hover:text-kid-orange/80">MediaFire</a>:
                  </p>
                  <a
